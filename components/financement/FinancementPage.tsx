  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-background text-foreground">
        ...
        {/* Section Caractéristiques - directement intégrée ici pour éviter l'erreur */}
        <section className="relative py-28 bg-gradient-to-b from-black to-black/90 overflow-hidden">
          {/* Grille de fond */}
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                >
                  <div className={`relative h-full rounded-2xl overflow-hidden ${feature.color} bg-opacity-5 backdrop-blur-sm border border-white/5 p-8 transition-all duration-300 hover:shadow-lg hover:shadow-primary/5 group`}>
                    ...
                    <div className="mt-auto pt-6 flex items-center">
                      ...
                      />
                      <span className="text-sm font-medium text-primary opacity-0 group-hover:opacity-100 transition-opacity duration-300">En savoir plus</span>
                    </div>
                  </div>
                </motion.div>
              ))}
