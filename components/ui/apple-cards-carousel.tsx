    ...
    >
      <div className="relative w-full">
        ...
        >
          <div
            className={cn(
              "flex flex-row justify-start gap-6 md:gap-8 px-6 md:px-8",
              "max-w-7xl mx-auto"
            )}
          >
            {items.map((item, index) => (
              <motion.div
                ...
                key={"card" + index}
                className="first:ml-0 last:mr-16 md:last:mr-24 flex-shrink-0"
              >
                {item}
              </motion.div>
            ))}
        ...
        <div className="flex justify-end gap-2 mr-6 md:mr-10 mt-4">
          <button
