...
export default function ControllerProblemsPage() {
      ...
      <main className="flex-grow pt-24 z-10">
        <div className="container mx-auto px-4 py-8">
          ...
          >
            ...
            <h1 className="text-4xl font-medium mb-4">Problèmes courants de contrôleur</h1>
            <p className="text-xl text-neutral-600 dark:text-neutral-400">
              Solutions et conseils pour résoudre les problèmes de contrôle les plus fréquents
            </p>
          </motion.div>
            ...
            <div className="lg:col-span-2">
              <div className="prose dark:prose-invert max-w-none">
                <section className="mb-12 bg-white dark:bg-neutral-800 rounded-2xl p-8 shadow-lg">
                  <h2 className="text-2xl font-semibold mb-6">Problèmes de réponse</h2>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-lg mb-4">
                        Les problèmes de réponse du contrôleur peuvent affecter la conduite.
                        Voici les solutions pour les cas les plus courants.
                      </p>
                      <div className="bg-neutral-100 dark:bg-neutral-700/50 rounded-lg p-4">
                        <p className="text-sm text-neutral-600 dark:text-neutral-400">
                          <strong>Note :</strong> Si le problème persiste après avoir essayé ces solutions,
                ...
                <section className="mb-12 bg-white dark:bg-neutral-800 rounded-2xl p-8 shadow-lg">
                  <h2 className="text-2xl font-semibold mb-6">Solutions rapides</h2>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-neutral-50 dark:bg-neutral-700/50 rounded-xl p-6">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <h3 className="text-lg font-medium">Vérifications de base</h3>
                      </div>
                      <ul className="space-y-3">
                        <li className="flex items-start gap-2">
                          <CheckCircle2 className="w-5 h-5 text-green-500 mt-0.5" />
                          <span>Nettoyer le contrôleur</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <CheckCircle2 className="w-5 h-5 text-green-500 mt-0.5" />
                          <span>Vérifier les connexions</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <CheckCircle2 className="w-5 h-5 text-green-500 mt-0.5" />
                          <span>Contrôler les boutons</span>
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className="bg-neutral-50 dark:bg-neutral-700/50 rounded-xl p-6">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <h3 className="text-lg font-medium">Réinitialisation</h3>
                      </div>
                      <ul className="space-y-3">
                        <li className="flex items-start gap-2">
                          <CheckCircle2 className="w-5 h-5 text-green-500 mt-0.5" />
                          <span>Redémarrer le contrôleur</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <CheckCircle2 className="w-5 h-5 text-green-500 mt-0.5" />
                        ...
                        <li className="flex items-start gap-2">
                          <CheckCircle2 className="w-5 h-5 text-green-500 mt-0.5" />
                          <span>Mettre à jour le firmware</span>
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <section className="mb-12 bg-white dark:bg-neutral-800 rounded-2xl p-8 shadow-lg">
                  <h2 className="text-2xl font-semibold mb-6">Problèmes de connexion</h2>
                      ...
                      <div>
                        ...
                        <ul className="space-y-3">
                          <li className="flex items-start gap-2">
                            ...
                            <span>Déconnexion fréquente</span>
                          </li>
                          <li className="flex items-start gap-2">
                            <AlertTriangle className="w-5 h-5 text-amber-500 mt-0.5" />
              ...
              <div className="sticky top-24">
                ...
                <div className="bg-white dark:bg-neutral-800 rounded-2xl p-6 shadow-lg">
                  ...
                  <ul className="space-y-4">
                    <li>
                      <Link href="/support/controleur/entretien" className="flex items-center gap-2 text-blue-600 dark:text-blue-400 hover:underline">
                        <ChevronRight className="w-4 h-4" />
                        Guide d'entretien
                      </Link>
                    </li>
                    <li>
                      <Link href="/support/controleur/parametres" className="flex items-center gap-2 text-blue-600 dark:text-blue-400 hover:underline">
                        <ChevronRight className="w-4 h-4" />
                        Paramètres de contrôle
                      </Link>
                    </li>
                    <li>
                      <Link href="/support/controleur/diagnostic" className="flex items-center gap-2 text-blue-600 dark:text-blue-400 hover:underline">
                        <ChevronRight className="w-4 h-4" />
                        Diagnostic avancé
                      </Link>
                    </li>
