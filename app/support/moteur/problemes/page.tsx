...
export default function MotorProblemsPage() {
      ...
      <main className="flex-grow pt-24 z-10">
        <div className="container mx-auto px-4 py-8">
          ...
          >
            ...
            <h1 className="text-4xl font-medium mb-4">Problèmes courants de moteur</h1>
            <p className="text-xl text-neutral-600 dark:text-neutral-400">
              Solutions et conseils pour résoudre les problèmes de moteur les plus fréquents
            </p>
          </motion.div>
            ...
            <div className="lg:col-span-2">
              <div className="prose dark:prose-invert max-w-none">
                <section className="mb-12 bg-white dark:bg-neutral-800 rounded-2xl p-8 shadow-lg">
                  <h2 className="text-2xl font-semibold mb-6">Problèmes de performance</h2>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-lg mb-4">
                        Les problèmes de performance du moteur peuvent se manifester de différentes manières.
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-neutral-50 dark:bg-neutral-700/50 rounded-xl p-6">
                      ...
                      <ul className="space-y-3">
                        ...
                        <li className="flex items-start gap-2">
                          <CheckCircle2 className="w-5 h-5 text-green-500 mt-0.5" />
                          <span>Contrôler les roulements</span>
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className="bg-neutral-50 dark:bg-neutral-700/50 rounded-xl p-6">
                      ...
                      <ul className="space-y-3">
                        <li className="flex items-start gap-2">
                          <CheckCircle2 className="w-5 h-5 text-green-500 mt-0.5" />
                          <span>Redémarrer la trottinette</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <CheckCircle2 className="w-5 h-5 text-green-500 mt-0.5" />
                          <span>Vérifier les paramètres</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <CheckCircle2 className="w-5 h-5 text-green-500 mt-0.5" />
                ...
                <section className="mb-12 bg-white dark:bg-neutral-800 rounded-2xl p-8 shadow-lg">
                  <h2 className="text-2xl font-semibold mb-6">Problèmes de température</h2>
                      ...
                      <div>
                        ...
                        <ul className="space-y-3">
                          <li className="flex items-start gap-2">
                            ...
                            <span>Moteur surchauffé</span>
                          </li>
                          <li className="flex items-start gap-2">
                            <AlertTriangle className="w-5 h-5 text-amber-500 mt-0.5" />
                            <span>Bruit anormal</span>
                          </li>
                          <li className="flex items-start gap-2">
                            <AlertTriangle className="w-5 h-5 text-amber-500 mt-0.5" />
                            <span>Perte de puissance</span>
                          </li>
                        </ul>
                      </div>
                    </div>
                ...
                <div className="bg-white dark:bg-neutral-800 rounded-2xl p-6 shadow-lg mb-6">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      ...
                      <span>Vérifier la performance</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="bg-blue-100 dark:bg-blue-900/30 p-1 rounded">
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span>Surveiller la température</span>
                    </li>
                  </ul>
                </div>
