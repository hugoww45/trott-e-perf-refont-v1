...
export default function BatteryProblemsPage() {
      ...
      <main className="flex-grow pt-24 z-10">
        <div className="container mx-auto px-4 py-8">
          ...
          >
            ...
            <h1 className="text-4xl font-medium mb-4">Problèmes courants de batterie</h1>
            <p className="text-xl text-neutral-600 dark:text-neutral-400">
              Solutions et conseils pour résoudre les problèmes de batterie les plus fréquents
            </p>
          </motion.div>
            ...
            <div className="lg:col-span-2">
              <div className="prose dark:prose-invert max-w-none">
                <section className="mb-12 bg-white dark:bg-neutral-800 rounded-2xl p-8 shadow-lg">
                  <h2 className="text-2xl font-semibold mb-6">Problèmes de charge</h2>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-lg mb-4">
                        Les problèmes de charge sont parmi les plus courants. Voici les solutions
                        pour les cas les plus fréquents.
                      </p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-neutral-50 dark:bg-neutral-700/50 rounded-xl p-6">
                      ...
                      <ul className="space-y-3">
                        <li className="flex items-start gap-2">
                          ...
                          <span>Vérifier les connecteurs</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <CheckCircle2 className="w-5 h-5 text-green-500 mt-0.5" />
                          <span>Nettoyer les contacts</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <CheckCircle2 className="w-5 h-5 text-green-500 mt-0.5" />
                          <span>Vérifier le chargeur</span>
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className="bg-neutral-50 dark:bg-neutral-700/50 rounded-xl p-6">
                      ...
                      <ul className="space-y-3">
                        <li className="flex items-start gap-2">
                          <CheckCircle2 className="w-5 h-5 text-green-500 mt-0.5" />
                          <span>Déconnecter la batterie</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <CheckCircle2 className="w-5 h-5 text-green-500 mt-0.5" />
                          <span>Attendre 5 minutes</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <CheckCircle2 className="w-5 h-5 text-green-500 mt-0.5" />
                          <span>Reconnecter et tester</span>
                        </li>
                      </ul>
                    </div>
                  </div>
                      ...
                      <div>
                        ...
                        <ul className="space-y-3">
                          <li className="flex items-start gap-2">
                            ...
                            <span>Batterie trop chaude</span>
                          </li>
                          <li className="flex items-start gap-2">
                            <AlertTriangle className="w-5 h-5 text-amber-500 mt-0.5" />
                            <span>Batterie trop froide</span>
                          </li>
                          <li className="flex items-start gap-2">
                            <AlertTriangle className="w-5 h-5 text-amber-500 mt-0.5" />
                ...
                <div className="bg-white dark:bg-neutral-800 rounded-2xl p-6 shadow-lg mb-6">
                  ...
                  <ul className="space-y-3">
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span>Réinitialiser la batterie</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="bg-blue-100 dark:bg-blue-900/30 p-1 rounded">
                        <Thermometer className="w-4 h-4 text-blue-600 dark:text-blue-400" />
                      </div>
                      <span>Contrôler la température</span>
                    </li>
                  </ul>
                </div>
